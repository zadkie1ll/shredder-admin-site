...
urlpatterns = [
    ...
    path("support/tickets/<int:ticket_id>/messages/", views.create_support_ticket_message, name="create_support_ticket_message"),
    path("support/tickets/<int:ticket_id>/messages-json/", views.support_ticket_messages_json, name="support_ticket_messages_json"),
    path("support/tickets/<int:ticket_id>/close/", views.close_support_ticket, name="close_support_ticket"),
    path("support/attachments/<int:attachment_id>/", views.support_attachment, name="support_attachment"),
    ...
    path("support-admin/tickets/<int:ticket_id>/close/", views.support_admin_close_ticket, name="support_admin_close_ticket"),
    path("support-admin/tickets/<int:ticket_id>/reopen/", views.support_admin_reopen_ticket, name="support_admin_reopen_ticket"),
    path("support-admin/tickets/<int:ticket_id>/delete/", views.support_admin_delete_ticket, name="support_admin_delete_ticket"),
    path("support-admin/attachments/<int:attachment_id>/", views.support_admin_attachment, name="support_admin_attachment"),
