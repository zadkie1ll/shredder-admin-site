...
Самые срочные проблемы связаны с доступом к аккаунтам и корректностью оплаченных подписок. Оплата на чужой email сейчас может дать доступ к этому аккаунту; статус платежа может быть взят из другого заказа/шлюза того же пользователя. Найдены пути сохранённого XSS в админке, рассогласования email с Remnawave, зависания web-потоков и ошибки установки нод. На маленьком мобильном экране есть воспроизведённая блокировка кнопки онбординга.
